 ...
 * @author mathe
 */
public class VisaoAdministradorEventoProcessado extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(VisaoAdministradorEventoProcessado.class.getName());
    ...
    public VisaoAdministradorEventoProcessado() {
        initComponents();
    }

    public VisaoAdministradorEventoProcessado(Usuario user) {
    ...
    List<Object[]> dados = dao.listarEventosProcessados();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EVENTOS PROCESSADOS");
 ...
 // Ação do botão Cadastrar Usuários: 
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new VisaoAdministradorEventoProcessado().setVisible(true));
    }
