 ...
 * @author mathe
 */
public class VisaoInvestidorProventosPagos extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(VisaoInvestidorProventosPagos.class.getName());
     ...
     */
    public VisaoInvestidorProventosPagos() {
        initComponents();
    ...
    public VisaoInvestidorProventosPagos(Usuario usuarioLogado) {
    ...
    // -------------------------------------------------------------------------
    //  METODO PARA POPULAR O COMBOBOX DE FILTRO POR ATIVO:
    // -------------------------------------------------------------------------
    
    private void carregarComboAtivos() {
    List<String> tickers = proventoDAO.listarTickersProventosPagosPorUsuario(usuarioLogado.getId());
    ...
    private void carregarTabelaProventosPagos() {
   
         DefaultTableModel modelo = (DefaultTableModel) TabelaProventosPagos.getModel();
    modelo.setRowCount(0); // Limpa a tabela

    List<Object[]> dados = proventoDAO.buscarProventosPagosPorUsuario(usuarioLogado.getId());
    ...
    for (Object[] linha : dados) {
        ...
        if (periodoSelecionado != null && !"Todos".equals(periodoSelecionado) && dataPagamento != null) {
            int mesPagamento = dataPagamento.toLocalDate().getMonthValue();
    ...
    private void initComponents() {
        ...
        TabelaProventosPagos = new javax.swing.JTable();
        ...
        jLabel1.setText("PROVENTOS RECEBIDOS");
        ...
        TabelaProventosPagos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID do Ativo", "Ticket", "Tipo", "Valor da Cota", "Quantidade Total", "Valor Investido", "Tipo", "Valor da Cota", "Data de Pagamento", "Status"
            }
        ));
        jScrollPane1.setViewportView(TabelaProventosPagos);
        ...
        jMenuItem9.setText("Proventos Pagos");
        btnProventos.add(jMenuItem9);
    ...
    carregarComboAtivos();
     ...
     carregarTabelaProventosPagos();

    // Listeners para atualizar tabela ao mudar filtros
    ComboBoxFiltraPorAtivo.addActionListener(e -> carregarTabelaProventosPagos());
   ComboBoxFiltraPorPeriodo.addActionListener(e -> carregarTabelaProventosPagos());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new VisaoInvestidorProventosPagos().setVisible(true));
    }
    ...
    private javax.swing.JTable TabelaProventosPagos;
